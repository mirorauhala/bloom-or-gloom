package fi.tuni.tamk.tiko.bloomorgloom2.Shop;
...
import fi.tuni.tamk.tiko.bloomorgloom2.Screens.ShopOtherScreen;
import fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.Product;
...
public class ShopMain {
    ...
    public Table getProductsTable(final Products products) {
        ...
        Gson gson = new Gson();
        final fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.OwnedProducts ownedProducts = gson.fromJson(ownedProductsJson, fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.OwnedProducts.class);
        ...
        for (final Product product : products.getProducts()) {
            ...
            buyButton.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    if(game.score.decrementWallet(product.getPrice())) {
                        ...
                        fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.OwnedProducts emptyOwnedProduct = new fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.OwnedProducts();
            ...
            table.setDebug(fi.tuni.tamk.tiko.bloomorgloom2.MyGdxGame.DEBUG); // turn on all debug lines (table, cell, and widget)
    ...
    public Table createShopTop(Label walletLabel) {
        ...
        Table table = new Table(skin);
        table.setDebug(fi.tuni.tamk.tiko.bloomorgloom2.MyGdxGame.DEBUG);
    ...
    public void updateButtons() {
        final fi.tuni.tamk.tiko.bloomorgloom2.Shop.Resources.OwnedProducts owned = new Gson().fromJson(game.inventory.getOwnedProducts(), OwnedProducts.class);
